...
// TypeScript file
var CashDailogView = (function (_super) {
    __extends(CashDailogView, _super);
    function CashDailogView() {
        var _this = _super.call(this, CashDailogView.NAME) || this;
        _this.func = null;
        _this.oldString = "";
        return _this;
    }
    CashDailogView.prototype.week = function () {
        var self = this;
    ...
    CashDailogView.prototype.setViewByData = function () {
    ...
    CashDailogView.prototype.isNumber = function (val) {
    ...
    CashDailogView.prototype.isRealNum = function (val) {
    ...
    CashDailogView.prototype.moveHandler = function (evt) {
        var self = this;
    ...
    CashDailogView.prototype.outHandler = function (evt) {
        var self = this;
        var num = parseInt(this.editCount.text);
    };
    CashDailogView.prototype.sleep = function () {
    };
    CashDailogView.prototype.SetTxt = function (txt) {
    };
    CashDailogView.prototype.touchTap = function (event) {
        var self = this;
    ...
    CashDailogView.NAME = "CashSkin";
    return CashDailogView;
}(BaseView));
__reflect(CashDailogView.prototype, "CashDailogView");
//# sourceMappingURL=CashDailogView.js.map