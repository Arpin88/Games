// TypeScript file
class CGCardItemView extends IBaseView{
    public static NAME:string = "CGCardItemSkin";

     public constructor(){
        super(CGCardItemView.NAME);
    }


    private groupCGCI:eui.Group;
    ...
    public setLockLabel(lv:number):void{
        var self = this;
