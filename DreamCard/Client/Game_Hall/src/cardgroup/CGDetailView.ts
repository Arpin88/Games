// TypeScript file
class CGDetailView extends BaseView{
    public static NAME:string = "CGDetailSkin";

     public constructor(){
        super(CGDetailView.NAME);
    }

    private groupCGDetail:eui.Group;
    ...
    private setSkillItem(data:any):void{
        ...
        var view:CGDSkillItemView = new CGDSkillItemView();
        view.initData(objData);
    ...
    private setFetterItem(data:any):void{
        ...
        var view:CGDFetterItemView = new CGDFetterItemView();
        view.initData(objData);
