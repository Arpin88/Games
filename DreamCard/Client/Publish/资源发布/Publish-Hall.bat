...
xcopy .\res-Hall\*.*  ..\Publish\资源发布\Game_Hall\res-Hall\ /S /Y /Q
...
@echo -----------------生成版本号json文件
cd ..\..\vertool
xcopy ..\资源发布\Game_Hall\vers\webver.ver .\data\checkver.ver /S /Y /Q
xcopy ..\资源发布\Game_Hall\vers\webver.json .\data\ /S /Y /Q
xcopy ..\资源发布\Game_Hall\vers\addver.json .\data\ /S /Y /Q
xcopy ..\资源发布\client\webver.ver .\data\ /S /Y /Q

@node main.js resource res-Hall

xcopy .\data\webver.json ..\资源发布\Game_Hall\vers\ /S /Y
xcopy .\data\webver.json ..\资源发布\patch\webver\res-Hall\ /S /Y
