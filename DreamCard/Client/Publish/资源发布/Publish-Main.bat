...
xcopy .\resource\*.* ..\Publish\资源发布\Client_Main\resource\ /S /Y /Q
...
@echo -----------------生成版本号json文件
cd ..\..\vertool
xcopy ..\资源发布\Client_Main\vers\webver.ver .\data\checkver.ver /S /Y /Q
xcopy ..\资源发布\Client_Main\vers\webver.json .\data\ /S /Y /Q
xcopy ..\资源发布\Client_Main\vers\addver.json .\data\ /S /Y /Q
xcopy ..\资源发布\client\webver.ver .\data\ /S /Y /Q

@call .\run.bat
xcopy .\data\webver.json ..\资源发布\Client_Main\vers\ /S /Y
xcopy .\data\webver.json ..\资源发布\patch\webver\ /S /Y
