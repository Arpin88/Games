...
xcopy .\res-Combat\*.*  ..\Publish\资源发布\Game_Combat\res-Combat\ /S /Y /Q
...
@echo -----------------生成版本号json文件
cd ..\..\vertool
xcopy ..\资源发布\Game_Combat\vers\webver.ver .\data\checkver.ver /S /Y /Q
xcopy ..\资源发布\Game_Combat\vers\webver.json .\data\ /S /Y /Q
xcopy ..\资源发布\Game_Combat\vers\addver.json .\data\ /S /Y /Q
xcopy ..\资源发布\client\webver.ver .\data\ /S /Y /Q

@node main.js resource res-Combat

xcopy .\data\webver.json ..\资源发布\Game_Combat\vers\ /S /Y
xcopy .\data\webver.json ..\资源发布\patch\webver\res-Combat\ /S /Y
