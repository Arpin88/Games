// TypeScript file
class CDfdHeadView extends IBaseView implements ExpFromImpl{
    public static NAME:string = "CDfdHeadSkin";

     public constructor(){
        super(CDfdHeadView.NAME);
    }
    ...
    private imgDisconnect:eui.Image;    //断线图标
    ...
    public setBreakLineState(state:number=1):void{
        var self = this;
        self.setViewColor(self,state!=0);
        self.lblPower.textColor = state==0?0xFFDA77:0xFFFFFF;
        self.lblName.textColor = state==0?0xF9D978:0xFFFFFF;
        self.setDisconnect(state!=0);
    }
    ...
    public setDisconnect(disconnect:boolean):void{
        this.imgDisconnect.visible = disconnect;
    }
