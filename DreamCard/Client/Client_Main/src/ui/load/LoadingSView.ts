...
class LoadingSView extends BaseView implements IGMDLoadProgress{
    
    public static NAME:string = "LoadingSSkin";
    ...
    public weekComplete():void{
        ...
        if(stage&&stage.orientation!=egret.OrientationMode.AUTO){
            ...
            var width:number = GlobalDef.SCREEN_WIDTH>GlobalDef.SCREEN_HEIGHT?GlobalDef.SCREEN_HEIGHT:GlobalDef.SCREEN_WIDTH;
            var height:number = GlobalDef.SCREEN_WIDTH>GlobalDef.SCREEN_HEIGHT?GlobalDef.SCREEN_WIDTH:GlobalDef.SCREEN_HEIGHT;
