...
class ForgotView extends BaseView{
    public static NAME:string = "ForgotSkin";
    public constructor(){
        super(ForgotView.NAME);
    }

    private groupForgot:eui.Group;
    ...
    private updateCurForgotType():void{
        var self = this;
    ...
    public onResetPasswordComplete():void{
        var self = this;
        PopManager.getInstance().showPromptBox(self.labelObj["lbl_0"],2,Handler.create(self,function(confirm:boolean){
            self.hiden();
        }));
    }
